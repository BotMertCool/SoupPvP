...
public class UserListener implements Listener {
    ...
    public void onFirstJoin(PlayerJoinEvent event){
        ...
        player.sendMessage(CC.translate("&7Welcome to &4Vex &dKitPvP!"));
        player.sendMessage("");
        player.sendMessage(CC.translate("&7Website: &fwww.vex.rip"));
        player.sendMessage(CC.translate("&7Store: &fstore.vex.rip"));
